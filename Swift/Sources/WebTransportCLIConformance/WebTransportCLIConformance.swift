...
private func statusToken(_ status: WebTransportCLIConformanceStatus) -> String {
    switch status {
...
private func count(_ status: WebTransportCLIConformanceStatus, in results: [WebTransportCLIConformanceResult]) -> Int {
