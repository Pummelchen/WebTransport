# The same pywebtransport/aioquic echo server the Swift interop uses, with aioquic's DEBUG logging ON so a
# question about HTTP/3 has an answer from the peer's own side (WT-135). Unchanged otherwise.
