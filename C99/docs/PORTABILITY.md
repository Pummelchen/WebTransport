...
`apps/` -- with the include paths and the one define CMake gives them, and they all compile for Windows: 74 + 103
...
runner or MSYS2 installation is needed), and builds **88 PE32+ executables** plus `libwebtransport.dll`. CI runs
...
tree compiles for Windows (74 + 103 sources, warnings-as-errors), links for Windows (88 PE32+ executables and a
