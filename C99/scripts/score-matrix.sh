...
echo "           warning set as errors (72 library sources and 97 test/app sources) and LINKS into 85"
echo "           PE32+ executables plus a shared library, and that link step is ENFORCED in CI now that it"
echo "           has been seen to finish. What remains is RUNNING what already builds (Windows or Wine) and"
