...
and 91,312 checks pass (plus a 200,000-input parser fuzz run and a Clang Static Analyzer pass over all 92 sources), and every suite runs again under AddressSanitizer and
